...
Commit the generated files to the current working branch. Do NOT push to main and do NOT set a remote URL / PAT — deployment is fully automated downstream.

```bash
git config user.name "Claude Code Routine"
